...
public class StatsDialog extends javax.swing.JDialog {
    ...
    private void fillData() {
        ...
        JSONObject jobj = req.sessionStats();
        System.out.println("[StatsDialog][fillData]" + jobj.toString());
        if (webClient != null) {
            try {
                webClient.processWebRequest(jobj, "StatsDialog");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(net.sf.dvstar.transmission.TransmissionApp.class).getContext().getResourceMap(StatsDialog.class);
        ...
        plTop.setPreferredSize(new java.awt.Dimension(730, 44));
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(net.sf.dvstar.transmission.TransmissionApp.class).getContext().getActionMap(StatsDialog.class, this);
